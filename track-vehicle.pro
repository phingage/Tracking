...
LIBS += -L/usr/local/lib -lopencv_calib3d -lopencv_features2d -lopencv_flann -lopencv_cudaimgproc -lopencv_cudaarithm -lopencv_xfeatures2d -lopencv_cudawarping -lopencv_cudaoptflow -lopencv_cudalegacy
